...
export class Tab2Page implements OnInit{
 ...
 constructor(private guestService: GuestService) {
   ...
   console.log(this.token);
    ...
    this.text2 = ["El código de acceso es la clave de la caja fuerte que contiene la llave de su habitación.","The access code is the key to the safe that contains your room key.","Le code d'accès est la clé du coffre-fort qui contient la clé de votre chambre."]
    this.text3 = ["Código: ","Code: ","Code: "]
    this.text4 = ["Código de acceso no disponible","Access code not available","Code d'accès non disponible"]
    this.text5 = ["Favor de regresar el día","Please return on","Veuillez revenir le"]
